...
class MultimediaController extends Controller
{
    ...
    public function crearMultimedia(Request $request)
    {
        ...
        return response()->json([
            'message' => 'Multimedia creada exitosamente' //multimedia se creó correctamente.
            ,
            'multimedia' => $multimedia
        ], 201); // Código de estado HTTP 201 ("Created") para indicar que la operación se completó con éxito.
    }
